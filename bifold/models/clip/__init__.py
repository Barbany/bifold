...
_MODELS = {
    "RN50": BASE_URL + "afeb0e10f9e5a86da6080e35cf09123aca3b358a0c3e3b6c78a7b63bc04b6762/RN50.pt",
    "RN101": BASE_URL + "8fa8567bab74a42d41c5915025a8e4538c3bdbe8804a470a72f30b0d94fab599/RN101.pt",
    "RN50x4": BASE_URL
...
def load(
    ...
    ----------
    name : str
        A model name listed by `clip.available_models()`, or the path to a model checkpoint
    ...
    preprocess : Callable[[PIL.Image], torch.Tensor]
        A torchvision transform that converts a PIL image into a tensor that the returned model
        can take as its input
    """
    if name in _MODELS:
    ...
    if str(device) == "cpu":
        ...
        float_input = list(float_holder.graph.findNode("aten::to").inputs())[1]  # type: ignore
...
def tokenize(
    ...
    We return LongTensor when torch version is <1.8.0, since older index_select requires
    indices to be long.
    """
