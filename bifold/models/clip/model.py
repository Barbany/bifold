...
class ModifiedResNet(nn.Module):
    ...
    - There are now 3 "stem" convolutions as opposed to 1, with an average pool instead
        of a max pool.
...
class CLIP(nn.Module):
    ...
    def encode_image_with_embeddings(self, image):
        return self.visual.forward_with_embeddings(image.type(self.dtype))
